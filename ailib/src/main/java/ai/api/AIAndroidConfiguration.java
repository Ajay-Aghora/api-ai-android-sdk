...
public class AIAndroidConfiguration extends AIConfiguration {
    ...
    public AIAndroidConfiguration(final String clientAccessToken, final SupportedLanguages language, final RecognitionEngine recognitionEngine) {
